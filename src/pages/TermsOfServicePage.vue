<template>
  <q-page>
    <section>
      <div class="container">
        <div class="text-h1 text-white">Imprint</div>

        <div class="text-h2 text-white">According to § 5 TMG</div>
        ...
        <div class="text-h2 text-white">Contact</div>
        <div class="text-body1 text-lightest q-pb-xl">
          baeni.saa@gmail.com
        </div>

        <div class="text-h1 text-white">Website Terms and Conditions of Use</div>
